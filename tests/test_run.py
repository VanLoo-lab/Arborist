...
def test_run_small(simulate_small):
    ...
    """
    try:
        likelihoods, best_fit= rank_trees(simulate_small.candidate_set, simulate_small.read_counts, alpha=0.001, max_iter=10)
        print(best_fit)
...
def test_run_med(simulate_medium):
    ...
    """
    try:
        likelihoods, best_fit= rank_trees(simulate_medium.candidate_set, simulate_medium.read_counts, alpha=0.001, max_iter=10)
        print(best_fit)
